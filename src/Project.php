...
final class Project
{
    protected static array $packages = [
        ...
        ['name' => 'Filament Image Compare', 'description' => 'Image Comparison / Two Up Entry for Before/After comparison.', 'image' => '/assets/images/packages/filament-image-compare.webp', 'link' => 'https://github.com/pxlrbt/filament-image-compare', 'paid' => false],
