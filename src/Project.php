...
final class Project
{
    protected static array $packages = [
        ...
        ['name' => 'Filament Changelog', 'description' => 'Display your GitHub releases in your Filament panel.', 'image' => './assets/images/packages/filament-changelog.webp', 'link' => 'https://store.pxlrbt.de/buy/bf12e45f-373a-491d-938e-e7386179bb3f', 'paid' => true, 'docs_url' => 'https://filament.pxlrbt.de/changelog/'],
        ...
        ['name' => 'Filament Spotlight Pro', 'description' => 'Browse your Filament Panel with ease.', 'image' => './assets/images/packages/filament-spotlight-pro.webp', 'link' => 'https://store.pxlrbt.de/buy/d70a8f51-09c3-4cf3-8b3a-8ace6e0f6de3', 'paid' => true,  'docs_url' => 'https://filament.pxlrbt.de/spotlight-pro/'],
